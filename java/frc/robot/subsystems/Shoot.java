...
public class Shooter extends SubsystemBase {
    private LazyTalonFX shooterParent;
    private LazyTalonFX shooterChild;
    ...
    public Shooter(Vision Vision) {
        ...
        shooterParent = new LazyTalonFX(Constants.Shooter.shooterParentConstats);
        shooterChild = new LazyTalonFX(Constants.Shooter.shooterChildConstants);

        shooterParent.configPID(Constants.Shooter.shooterPID);
        shooterChild.follow(shooterParent);
    ...
    public double getShooterRPM(){
        return Conversions.falconToRPM(shooterParent.getSelectedSensorVelocity(), Constants.Shooter.shooterGearRatio);
    }
    ...
    public void setShooterRPM(double shooterRPM){
        ...
        shooterParent.set(ControlMode.Velocity, falconVelocity);
    }
    ...
    public void periodic() {
        ...
        SmartDashboard.putNumber("MShooter Temp", shooterParent.getTemperature());
        SmartDashboard.putNumber("SShooter Temp", shooterParent.getTemperature());
    }
}
